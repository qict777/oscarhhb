// 从current_groups里拿到最新比赛的match信息
// 联赛球队参加的最新赛季的各个杯赛比赛信息（盘路+大小球）  2014-03-05
...
league_info = db.current_groups.find({"league_type":2},{"_id":1,"league_name":1});
  ...
  season_id = groups_info['year'];
    ...
    if(groups_info){
		...
		// away 全场盘路 赛     上盘     平盘     下盘     赢     走     输     净     胜%     走%     负%
                  ...
                  away_r = Array(NumberInt(yp_home_total),NumberInt(yp_home_up), NumberInt(yp_home_mid), NumberInt(yp_home_down), NumberInt(home_w_yp), NumberInt(home_g_yp), NumberInt(home_l_yp), NumberInt(home_gd_yp), home_per_w_yp, home_per_g_yp, home_per_l_yp);
		...
		// // total 全场盘路 赛     上盘     平盘     下盘     赢     走     输     净     胜%     走%     负%
                  ...
                  total_r = Array(NumberInt(v91),NumberInt(v92), NumberInt(v93), NumberInt(v94), NumberInt(v95), NumberInt(v96), NumberInt(v97), NumberInt(v98), home_per_w_yp, home_per_g_yp, home_per_l_yp);
...
// home 半场盘路 赛     上盘     平盘     下盘     赢     走     输     净     胜%     走%     负%
                  ...
                  home_r_half = [NumberInt(yp_home_total),NumberInt(yp_home_up), NumberInt(yp_home_mid), NumberInt(yp_home_down), NumberInt(home_w_yp), NumberInt(home_g_yp), NumberInt(home_l_yp), NumberInt(home_gd_yp), home_per_w_yp, home_per_g_yp, home_per_l_yp];            
...
// away 半场盘路 赛     上盘     平盘     下盘     赢     走     输     净     胜%     走%     负% 
                  ...
                  away_r_half = [NumberInt(yp_home_total),NumberInt(yp_home_up), NumberInt(yp_home_mid), NumberInt(yp_home_down), NumberInt(home_w_yp), NumberInt(home_g_yp), NumberInt(home_l_yp), NumberInt(home_gd_yp), home_per_w_yp, home_per_g_yp, home_per_l_yp];
...
// total 半场盘路 赛     上盘     平盘     下盘     赢     走     输     净     胜%     走%     负% 
                  ...
                  total_r_half = Array(NumberInt(v61), NumberInt(v62), NumberInt(v63), NumberInt(v64), NumberInt(v65), NumberInt(v66), NumberInt(v67), NumberInt(v68), home_per_w_yp, home_per_g_yp, home_per_l_yp);
...
// away 全场大小球 赛 大球  走 小球  大球% 走%  小球%
                  ...
                  dx_away_r =  Array(NumberInt(dx_home_total), NumberInt(home_w_dx), NumberInt(home_g_dx), NumberInt(home_l_dx), home_per_w_dx, home_per_g_dx, home_per_l_dx);
...
// total 全场大小球 赛 大球  走 小球  大球% 走%  小球%
                  ...
                  dx_total_r = [NumberInt(v1),NumberInt(v2),NumberInt(v3),NumberInt(v4),v5,v6,v7];
...
// home 半场大小球 赛 大球  走 小球  大球% 走%  小球%
                  ...
                  dx_home_r_half = Array(NumberInt(dx_home_total), NumberInt(home_w_dx), NumberInt(home_g_dx), NumberInt(home_l_dx), home_per_w_dx, home_per_g_dx, home_per_l_dx);
...
// away 半场大小球 赛 大球  走 小球  大球% 走%  小球%
                  ...
                  dx_away_r_half = Array(NumberInt(dx_home_total), NumberInt(home_w_dx), NumberInt(home_g_dx), NumberInt(home_l_dx), home_per_w_dx, home_per_g_dx, home_per_l_dx);
...
// total 半场大小球 赛 大球  走 小球  大球% 走%  小球%
                  ...
                  dx_total_r_half= Array(NumberInt(v1),NumberInt(v2),NumberInt(v3),NumberInt(v4),v5,v6,v7);
...
// 大小盘路函数计算结束
		...
		db.team.update({"_id":team_id,"team_beisai.league_id":league_id},{"$set":{"team_beisai.$.yp_total":[total_r,home_r,away_r],"team_beisai.$.yp_total_half":[total_r_half,home_r_half,away_r_half],"team_beisai.$.dx_total":[dx_total_r,dx_home_r,dx_away_r],"team_beisai.$.dx_total_half":[dx_total_r_half,dx_home_r_half,dx_away_r_half]}});
