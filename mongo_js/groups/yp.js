...
// // 全场盘路计算---------------------------------------------------------------------------------
        ...
        total_r= Array(NumberInt(team_id),teamname,NumberInt(yp_total_total),NumberInt(yp_total_up), NumberInt(yp_total_mid), NumberInt(yp_total_down), NumberInt(total_w_yp), NumberInt(total_g_yp), NumberInt(total_l_yp), NumberInt(total_gd_yp), total_per_w_yp, total_per_g_yp, total_per_l_yp);

        home_r = Array(NumberInt(team_id),teamname, NumberInt(yp_home_total),NumberInt(yp_home_up), NumberInt(yp_home_mid), NumberInt(yp_home_down), NumberInt(home_w_yp), NumberInt(home_g_yp), NumberInt(home_l_yp), NumberInt(home_gd_yp), home_per_w_yp, home_per_g_yp, home_per_l_yp);

        away_r = Array(NumberInt(team_id),teamname, NumberInt(yp_away_total),NumberInt(yp_away_up), NumberInt(yp_away_mid), NumberInt(yp_away_down), NumberInt(away_w_yp), NumberInt(away_g_yp), NumberInt(away_l_yp), NumberInt(away_gd_yp), away_per_w_yp, away_per_g_yp, away_per_l_yp);
...
// 盘路判断函数
      ...
      db.groups.update({"_id": groups_id}, {"$set": {"yp_total": A,"yp_home": B,"yp_away": C,"yp_total_half": D,"yp_home_half": E,"yp_away_half": F}});
