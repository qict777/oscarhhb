...
// // total 半场大小球 赛 大球  走 小球  大球% 走%  小球%
  ...
  // // 球队名称  赛 大球  走 小球  大球% 走%  小球%
        ...
        total_r = Array(NumberInt(team_id),teamname, NumberInt(dx_total_total), NumberInt(total_w_dx), NumberInt(total_g_dx), NumberInt(total_l_dx), total_per_w_dx, total_per_g_dx, total_per_l_dx);

        home_r =  Array(NumberInt(team_id),teamname, NumberInt(dx_home_total), NumberInt(home_w_dx), NumberInt(home_g_dx), NumberInt(home_l_dx), home_per_w_dx, home_per_g_dx, home_per_l_dx);
        
        away_r =  Array(NumberInt(team_id),teamname, NumberInt(dx_away_total), NumberInt(away_w_dx), NumberInt(away_g_dx), NumberInt(away_l_dx), away_per_w_dx, away_per_g_dx, away_per_l_dx);
...
// // 半场大小球计算----------------------------------------------------------------------------------
        ...
        total_r_half = Array(NumberInt(team_id),teamname, NumberInt(dx_total_total_half), NumberInt(total_w_dx_half), NumberInt(total_g_dx_half), NumberInt(total_l_dx_half), total_per_w_dx_half, total_per_g_dx_half, total_per_l_dx_half);

        home_r_half = Array(NumberInt(team_id),teamname, NumberInt(dx_home_total_half), NumberInt(home_w_dx_half), NumberInt(home_g_dx_half), NumberInt(home_l_dx_half), home_per_w_dx_half, home_per_g_dx_half, home_per_l_dx_half);
        
        away_r_half = Array(NumberInt(team_id),teamname, NumberInt(dx_away_total_half), NumberInt(away_w_dx_half), NumberInt(away_g_dx_half), NumberInt(away_l_dx_half), away_per_w_dx_half, away_per_g_dx_half, away_per_l_dx_half);

        total_rr_half.push(total_r_half);
        home_rr_half.push(home_r_half);
        away_rr_half.push(away_r_half);
...
// // 更新统计的数据到集合中----------------------------------------------------------------------------------
      ...
      db.groups.update({"_id": groups_id}, {"$set": {"dx_total": A,"dx_home": B,"dx_away": C,"dx_total_half": D,"dx_home_half": E,"dx_away_half": F}});
